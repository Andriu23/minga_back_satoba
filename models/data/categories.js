...
let categories = [
  {
    ...
    hover: "#FFE0DF",
    description:
      "Is the manga that is aimed at adolescent boys. They are series with large amounts of action, in which humorous situations often occur.",
    character_photo: "https://i.postimg.cc/0jdQ27GW/shonen-character.png",
    cover_photo: "https://i.postimg.cc/SK3jZSNr/shonen-cover.png",
    admin_id: "alejandro@mh.com.ar",
  },
  {
    name: "comics",
    color: "#8883F0",
...
async function add_categories() {
  for (let category of categories) {
    console.log('searching user by email:', category.admin_id)
